...
from hummingbot.strategy.avellaneda_hedging.avellaneda_hedging_pair import AvellanedaHedgingPair
from hummingbot.strategy.avellaneda_hedging.avellaneda_hedging import AvellanedaHedgingStrategy
from hummingbot.strategy.avellaneda_hedging.avellaneda_hedging_config_map import \
    avellaneda_hedging_config_map as xemm_map
...
def start(self):
    ...
    self.market_pair = AvellanedaHedgingPair(maker=maker_market_trading_pair_tuple, taker=taker_market_trading_pair_tuple)

    strategy_logging_options = (
        AvellanedaHedgingStrategy.OPTION_LOG_CREATE_ORDER
        | AvellanedaHedgingStrategy.OPTION_LOG_ADJUST_ORDER
        | AvellanedaHedgingStrategy.OPTION_LOG_MAKER_ORDER_FILLED
        | AvellanedaHedgingStrategy.OPTION_LOG_REMOVING_ORDER
        | AvellanedaHedgingStrategy.OPTION_LOG_STATUS_REPORT
        | AvellanedaHedgingStrategy.OPTION_LOG_MAKER_ORDER_HEDGED
    )
    self.strategy = AvellanedaHedgingStrategy()
