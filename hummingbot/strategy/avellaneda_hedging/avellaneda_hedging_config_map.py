...
def maker_trading_pair_prompt():
    maker_market = avellaneda_hedging_config_map.get("maker_market").value
...
def taker_trading_pair_prompt():
    taker_market = avellaneda_hedging_config_map.get("taker_market").value
...
def top_depth_tolerance_prompt() -> str:
    maker_market = avellaneda_hedging_config_map["maker_market_trading_pair"].value
...
def order_amount_prompt() -> str:
    trading_pair = avellaneda_hedging_config_map["maker_market_trading_pair"].value
...
def update_oracle_settings(value: str):
    c_map = avellaneda_hedging_config_map
...
avellaneda_hedging_config_map = {
    "strategy": ConfigVar(key="strategy",
                          prompt="",
                          default="avellaneda_hedging"
                          ),
